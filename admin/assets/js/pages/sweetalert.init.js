...
//Basic
document.getElementById("sa-clock").addEventListener("click", function() {
    Swal.fire(
        {
...
document.getElementById("sa-clockout").addEventListener("click", function() {
    Swal.fire(
        {
            title: 'You Are Clocked Out Successfully',
            confirmButtonColor: '#1c84ee',
        }
    )
});

document.getElementById("sa-somethingwentwrong").addEventListener("click", function() {
    Swal.fire(
        {
...
document.getElementById("sa-taskadded").addEventListener("click", function() {
    Swal.fire(
        {
