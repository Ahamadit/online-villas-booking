                        ...
                        if (password_verify($password, $hashed_password)) {
                            ...
                            if ($isadmin == "1")
                            {
                                if ($isvalid == "1")
                                {
                                    ...
                                    if (isset($_SESSION['clock_in']) && $_SESSION['clock_in'] == 1)
                                    {
                                        $_SESSION['clock_in'] = 1;
                                    }
                                    else
                                    ...
                                    header("location: index.php");
                                        ...
                                        $password_err = "User is not verified";
                                    }
                                }
                            else {
                                // Display an error message if password is not valid
                                $password_err = "You are not admin";
                            }
...
<head>
    ...
    <title><?php echo $language["Login"]; ?> | Admin Panel</title>
                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="index.php" class="d-block auth-logo">
                                    <img src="assets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">Admin Panel</span>
                                </a>
                            </div>
                            <div class="auth-content my-auto">
                                ...
                                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                    <div class="form-floating form-floating-custom mb-4">
                                        <input type="text" class="form-control <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>" id="\username" name="username" placeholder="Enter User Name">
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>
                                    ...
                                    </script> Admin Panel . Made With <i class="mdi mdi-heart text-danger"></i> by Ikhwanul Haqq</p>
                            </div>
                        </div>
                    </div>
                </div>
