...
?>
                ...
                <div class="row">
                        ...
                        $sql = "SELECT * FROM araz WHERE status = 'deleted' order by id desc";
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3 pt-1">
                                        ...
                                        <p class="text-muted mb-0">
                                            <i class="font-size-15 align-middle pe-2 text-primary"></i>
                                            Mobile : <a href="tel:<?php echo $row["number"]; ?>"><?php echo $row["number"]; ?></a>
                                        </p>
                                        <p class="text-muted mb-0">
                                            <i class="font-size-15 align-middle pe-2 text-primary"></i>
                                ...
                                <div class="btn-group" role="group">
                                    <form style="margin-right: auto;margin-left: auto;" action="delete-araz-forever.php" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-primary" style=" width:130px; background-color: #28a745; border: none; padding: 8px 15px; border-radius: 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.2); font-weight: bold; color: white; transition: background-color 0.3s, box-shadow 0.3s;">
                                            <i class="uil uil-envelope-alt me-1"></i> Delete Forever
                                        </button>
                                    </form>
                                    ...
                                    <form style="margin-right: auto;margin-left: auto;" action="restore-araz.php" method="POST">
                                        <input type="hidden" name="id" id="id" value="<?php echo $row["id"]; ?>">
                                        <button type="submit" class="btn btn-primary" style=" width:130px; background-color: #28a745; border: none; padding: 8px 15px; border-radius: 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.2); font-weight: bold; color: white; transition: background-color 0.3s, box-shadow 0.3s;">
                                            <i class="uil uil-envelope-alt me-1"></i> Restore
                                        </button>
                                    </form>
                                </div>
                                <br>
