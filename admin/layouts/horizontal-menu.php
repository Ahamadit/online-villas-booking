         ...
         <div class="d-flex">
             ...
             <div class="dropdown d-inline-block language-switch">
                 ...
                 <?php
                    ...
                    ?>
                    <img class="header-lang-img" src="<?php echo $imgPath; ?>" alt="Header Language" height="16">
                 </button>
                                             ...
                                             <div class="row g-0">
                                                 ...
                                                 <div class="col-lg-5">
                                                     <div>
                                                         ...
                                                         <a href="ui-utilities.php" class="dropdown-item" data-key="t-colors"><?php echo $language['Utilities'] ?> </a>
                                                     </div>
                                                 </div>
                                             </div>
                                         </div>
                         ...
                         <div class="dropdown-menu" aria-labelledby="topnav-pages">
                             ...
                             <div class="dropdown">
                                 ...
                                 <div class="dropdown-menu" aria-labelledby="topnav-ecommerce">
                                     ...
                                     <a href="ecommerce-seller.php" class="dropdown-item" data-key="t-shops"><?php echo $language['Seller'] ?> </a>
                                     <a href="ecommerce-sale-details.php" class="dropdown-item" data-key="t-add-product"><?php echo $language['Sale-Details'] ?> </a>
                                 </div>
                             </div>
                             ...
                             <div class="dropdown">
                                 ...
                                 <div class="dropdown-menu" aria-labelledby="topnav-tasks">
                                     <a href="tasks-list.php" class="dropdown-item" data-key="t-task-list"><?php echo $language['Task_List'] ?> </a>
                                     <a href="tasks-kanban.php" class="dropdown-item" data-key="t-kanban-board"><?php echo $language['Kanban_Board'] ?> </a>
                                     <a href="tasks-create.php" class="dropdown-item" data-key="t-create-task"><?php echo $language['Create_Task'] ?> </a>
                                 </div>
                             </div>
                             <div class="dropdown">
