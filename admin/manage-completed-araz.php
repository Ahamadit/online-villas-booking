        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    $sql = "SELECT * FROM completed_araz order by id desc";
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="card">
                                    ...
                                    <div class="btn-group" role="group">
                                        <form style="margin-right: auto;margin-left: auto;" action="view-completed-user-files.php" method="POST" style="margin-right: 10px;">
                                            <input type="hidden" name="id" id="fileId" value="<?php echo $row["id"]; ?>">
                                            <button type="submit" class="btn btn-primary" style=" width:130px; background-color: #17a2b8; border: none; padding: 8px 15px; border-radius: 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.2); font-weight: bold; color: white; transition: background-color 0.3s, box-shadow 0.3s;">
                                                View Files
                                            </button>
                                        </form>
                                        <form style="margin-right: auto;margin-left: auto;" style="padding-left:auto;" action="view-completed-user-reply.php" method="POST">
                                            <input type="hidden" name="id" id="replyId" value="<?php echo $row["id"]; ?>">
