...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO employees (employee_name, designation_id, department_id, date_of_joining, work_location, salary, email, number, aadhar_number, pan_number, bank_account_number)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Enter Employee Details</h4>
                                <form method="post" action="add-employee.php" enctype="multipart/form-data">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="employeeName" name="employee_name" type="text" class="form-control" placeholder="Enter Employee Name..." required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-10">
                                            <select id="designationId" name="designation_id" class="form-control" required>
                                                ...
                                                while ($designationRow = $designationResult->fetch_assoc()) {
                                                    echo "<option value='{$designationRow['id']}'>{$designationRow['name']}</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="dateOfJoining" name="date_of_joining" type="date" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="workLocation" name="work_location" type="text" class="form-control" placeholder="Enter Work Location...">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="number" name="number" type="text" class="form-control" placeholder="Enter Contact Number...">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="aadharNumber" name="aadhar_number" type="text" class="form-control" placeholder="Enter Aadhar Number...">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="panNumber" name="pan_number" type="text" class="form-control" placeholder="Enter PAN Number...">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="bankAccountNumber" name="bank_account_number" type="text" class="form-control" placeholder="Enter Bank Account Number...">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-lg-10">
                                            <button type="submit" class="btn btn-success">Submit Employee</button>
